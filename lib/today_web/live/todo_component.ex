defmodule TodayWeb.TodoComponent do
    use TodayWeb, :live_component
    
    def render(assigns) do
    ~L"""
        <%= if @todo.completed do %>
            <li id="<%= @id %>" class="todo-list-item todo-list-item--completed">
        <% else %>
            <li id="<%= @id %>" class="todo-list-item">
        <% end %>
        <label for="todo-item-<%=@todo.id %>" class="todo-list-item__label">
        <%= if @todo.completed do %>
        ...
        <button class="todo-list-item__delete" phx-click="delete" phx-value-id="<%= @todo.id %>">
